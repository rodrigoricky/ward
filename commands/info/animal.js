...
const DOG_API_KEY   = "a8161fe6-e6f3-4a5b-8f35-8e3bd5332105"; 

module.exports = {
	name: "animal",
	description: 'Get random animal & thier description.',
	usage: '',
	cooldown: 5,
	aliases: ["animalimg"],
	...
	execute(message, args) {
        ...
        try{
            ...
            message.channel.send({ content: "> ***"+breed.name + "*** \r *"+ "`" + breed.temperament+ "`" +"*", files: [ image.url ] });
